...
Notice that you will only receive attachments up to the limit of 0.5MB, so if the user talks about a file and you don't see it, the file is probably bigger than the limit, so warn the user about that.
